...
import {TextField, Button, Typography, Paper, Select, MenuItem, FormControl, InputLabel, Tooltip, IconButton, Dialog, DialogTitle, DialogContent} from '@material-ui/core';
...
const Form = ({currentId, setCurrentId, openPopup, setOpenPopup}) => {
      ...
      <Dialog open={openPopup}>
        ...
        <DialogTitle >
          <div style={{display: 'flex'}}>
            <Typography variant="h6" style={{flexGrow: 1}} >  {currentId ? `Editing distro : ${distro.distroName}` : 'Add a new distro'}</Typography >
            <Tooltip title="Close" aria-label="close" ><IconButton onClick={() => clear()}><CloseIcon /></IconButton></Tooltip>
          </div>
        </DialogTitle>
